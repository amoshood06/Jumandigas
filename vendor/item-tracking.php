        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#" class="text-black hover:text-primary font-semibold">Track Order</a>
                    <a href="#" class="text-black hover:text-primary">My Account</a>
                    <a href="#" class="bg-primary text-white px-8 py-2 rounded-full hover:bg-orange-700">Logout</a>
                </nav>
    ...
    <div class="mobile-menu fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-50 md:hidden">
        <div class="p-4">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <a href="#" class="text-black hover:text-primary font-semibold">Track Order</a>
                <a href="#" class="text-black hover:text-primary">My Account</a>
                <a href="#" class="bg-primary text-white px-6 py-2 rounded-full text-center hover:bg-orange-700">Logout</a>
            </div>
        </div>
    </div>
